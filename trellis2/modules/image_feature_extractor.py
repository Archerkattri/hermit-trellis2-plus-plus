...
class DinoV3FeatureExtractor:
    ...
    def extract_features(self, image: torch.Tensor) -> torch.Tensor:
        ...
        # transformers >=5.7 nests the block ModuleList at model.model.layer
        _blocks = getattr(self.model, "layer", None) or self.model.model.layer
        for i, layer_module in enumerate(_blocks):
